...
class TestGeneratedCodeSyntax:
    ...
    def test_generated_form_is_valid_python(self):
        ...
        scaffold = Scaffold("Comment", ["body:text", "post:references", "user:references"])
    ...
    def test_generated_code_can_be_executed_in_mock_environment(self):
        ...
        scaffold = Scaffold("Product", ["name:string", "price:float", "category:references"])
...
""")
            ...
            form_code_modified = form_code.replace(
            ...
            try:
                ...
                exec(f"from app.forms.product import ProductForm")
            except SyntaxError as e:
                pytest.fail(f"Generated form cannot be imported due to syntax error: {e}")
